...
create table adresse (id bigint not null auto_increment, version bigint not null, adresse varchar(255) not null, postal integer not null, country varchar(255) not null, city varchar(255) not null, primary key (id));
...
create table customer (id bigint not null auto_increment, version bigint not null, last_name varchar(255) not null, adresse varchar(255) not null, postal integer not null, firm varchar(255), city varchar(255) not null, country varchar(255) not null, phone_number varchar(255) not null, e_mail varchar(255) not null, first_name varchar(255) not null, primary key (id));
...
create table member (id bigint not null, miles integer, code varchar(255) unique, sponsor_id bigint, password varchar(255), friend_miles integer, active bit, subscribe_date datetime, activation_id bigint, primary key (id));
...
create table travel (id bigint not null auto_increment, version bigint not null, depart_id bigint not null, status varchar(255) not null, handicap bit not null, travel_date datetime not null, customer_id bigint not null, destination_id bigint not null, travel_minute integer not null, creation_date datetime not null, travel_hour integer not null, price double precision not null, number_of_personne integer not null, comment varchar(255), travels_idx integer, primary key (id));
