...
create table special_condition (id bigint not null auto_increment, version bigint not null, start_date datetime not null, value double precision not null, label varchar(255) not null, end_date datetime, type varchar(255) not null, primary key (id));
