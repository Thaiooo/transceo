<html>
    ...
    <body>
    	...
    	<g:form method="post" >
    		...
    		<g:message code="label.rate.level" />: ${fieldValue(bean:rate,field:'level')}
    		<br/>
    		<g:message code="label.rate.value" />
    		<g:textField name="rate" value="${fieldValue(bean:rate,field:'rate')}" size="3"/>
    		
    		<p class="boutons">
	    		<g:actionSubmit value="${message(code:'label.common.button.save')}" action="update" /> 
    			<g:actionSubmit value="${message(code:'label.common.button.delete')}" action="deleteRate" />
