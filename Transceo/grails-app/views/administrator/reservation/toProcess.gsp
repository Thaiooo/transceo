    	...
    	<g:else>
	    	<table class="spip" width="100%">
    			<thead>
	    			<tr class="row_first">
		    			<th></th>
		    			<g:sortableColumn action="sortReservationToProcess" property="id" title="${message(code:'travel.id')}" />
		    			<g:sortableColumn action="sortReservationToProcess" property="creationDate" title="${message(code:'travel.creationdate')}" />
		    			<g:sortableColumn action="sortReservationToProcess" property="customer" title="${message(code:'travel.member')}" />
		    			<g:sortableColumn action="sortReservationToProcess" property="travelDate" title="${message(code:'travel.traveldate')}" />
		    			<th><g:message code="label.travel.depart" /></th>
		    			<th><g:message code="label.travel.destination" /></th>
		    			<g:sortableColumn action="sortReservationToProcess" property="numberOfPersonne" title="${message(code:'travel.number.personne')}" />
		    		</tr>
	    		</thead>
	    		<tbody>
