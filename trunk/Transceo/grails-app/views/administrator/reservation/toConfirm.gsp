    	...
    	<g:else>
	    	<table class="spip" width="100%">
    			<thead>
	    			<tr class="row_first">
		    			<th></th>
		    			<g:sortableColumn action="sortReservationToConfirm" property="id" title="${message(code:'label.travel.id')}" />
		    			<g:sortableColumn action="sortReservationToConfirm" property="creationDate" title="${message(code:'label.travel.creation.date')}" />
		    			<g:sortableColumn action="sortReservationToConfirm" property="customer" title="${message(code:'label.travel.member')}" />
		    			<g:sortableColumn action="sortReservationToConfirm" property="travelDate" title="${message(code:'label.travel.traveldate')}" />
		    			<th><g:message code="label.travel.depart" /></th>
		    			<th><g:message code="label.travel.destination" /></th>
		    			<g:sortableColumn action="sortReservationToConfirm" property="numberOfPersonne" title="${message(code:'label.travel.number.personne')}" />
		    		</tr>
	    		</thead>
	    		<tbody>
