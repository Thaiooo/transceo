...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="page_sommaire">
		<div id="page">
			...
			<div id="entete">
				<a rel="start home" href="http://transeo-paris.com/" title="<g:message code="label.page.layout.1.1" />" class="accueil"><img class="spip_logos" alt="" src="${resource(dir:'images',file:'siteon0.png')}" width="362" height="163" /> <strong class="masque"><g:message code="label.page.layout.1.2" /></strong></a>
				<div id="descriptif">
												...
												<g:form controller="travel" action="initBookEtape1" method="post" >
													<table>
														...
														<tr>
															...
															<g:select name="travelMinute" from="${['0','15','30','45']}" value="${travelMinute}" noSelection="['':'MM']"/></td>
														</tr>
														<tr>
